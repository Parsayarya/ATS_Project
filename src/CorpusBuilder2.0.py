...
# xlsx_to_csv(r'..\listofpapersAIP.xlsx',
#             r'..\listofpapersAIP.csv')
# xlsx_to_csv(r'..\listofpapersAWP.xlsx',
#             r'..\listofpapersAWP.csv')
# xlsx_to_csv(r'..\listofpapersSIP.xlsx',
#             r'..\listofpapersSIP.csv')
# xlsx_to_csv(r'..\listofpapersSWP.xlsx',
#             r'..\listofpapersSWP.csv')
# csv2name(r'..\listofpapersAIP.csv')
# csv2name(r'..\listofpapersAWP.csv')
# csv2name(r'..\listofpapersSIP.csv')
# csv2name(r'..\listofpapersSWP.csv')
...
# df = build_text_df(r'..\docxOutputs\SWPN')
# main_df = pd.read_csv(r'..\listofpapersSWP.csv')
# merged_df = main_df.merge(df, on=['Generated_Name'], how='left')
# merged_df.to_csv(r'..\SWPFinalCorpus.csv', index=False)
...
file_paths = [
    r'..\IPFinalCorpus.csv',
    r'..\SIPFinalCorpus.csv',
    r'..SWPFinalCorpus.csv',
    r'..\WPFinalCorpus.csv',
    r'..\ScopusCorpus.csv'
]
...
final_csv_path = r'..\FinalCorpus2.csv'
